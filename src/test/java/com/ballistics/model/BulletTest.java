...
import com.ballistics.BulletCatalog;
...
class BulletTest {
    ...
    @Test
    void catalogContainsTenBullets() {
        assertThat(BulletCatalog.load()).hasSize(10);
    }

    @Test
    void catalogContainsExpectedIds() {
        Set<String> ids = BulletCatalog.load().stream()
            .map(Bullet::id)
    ...
    void bulletProperties_223Rem() {
        Bullet b = BulletCatalog.findById("223-rem-55gr");
    ...
    void bulletProperties_308Win() {
        Bullet b = BulletCatalog.findById("308-win-168gr");
    ...
    void bulletProperties_3006() {
        Bullet b = BulletCatalog.findById("3006-150gr");
    ...
    void bulletProperties_65Creedmoor() {
        Bullet b = BulletCatalog.findById("65-creedmoor-140gr");
    ...
    void bulletProperties_338LapuaMagnum() {
        Bullet b = BulletCatalog.findById("338-lapua-250gr");
    ...
    void bulletProperties_6mmCreedmoor() {
        Bullet b = BulletCatalog.findById("6mm-creedmoor-108gr");
    ...
    @Test
    void allCatalogBulletsHavePositivePhysicalProperties() {
        BulletCatalog.load().forEach(b -> {
    ...
    @Test
    void catalogFromYamlIsUnmodifiable() {
        List<Bullet> bullets = BulletCatalog.load();
